  ...
  return (
    <div className="backdrop-blur-[14.9px] bg-black/80 border border-white/10 rounded-xl md:rounded-2xl p-2 md:p-4 w-[18.75rem] sm:w-[20rem] md:w-[26.25rem] shadow-[inset_0px_14.368px_57.47px_0px_rgba(0,0,0,0.3)]">
      ...
      <div className="mb-4 md:mb-6">
        <div className="text-[#9CA3AF] text-[0.625rem] sm:text-[0.75rem] md:text-[0.875rem] font-['Arial',sans-serif] mb-2 text-center">
          Voltage
        </div>
        <div className="flex items-center justify-center gap-2 md:gap-3">
          <span className="text-white text-xl sm:text-2xl md:text-[2.5rem] font-['Gemunu_Libre',sans-serif] font-normal">
            {voltageFrom}
          </span>
          <span className="text-white text-sm sm:text-base md:text-[1.5rem]">→</span>
          <span className="text-[#FF6B00] text-xl sm:text-2xl md:text-[2.5rem] font-['Gemunu_Libre',sans-serif] font-normal">
            {voltageTo}
          </span>
        </div>
      </div>
