    ...
    <section className="relative w-full h-[450px] sm:h-[600px] md:h-[700px] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
          ...
          <button className="bg-[#ff6b1a] text-black font-semibold px-6 sm:px-10 py-2.5 sm:py-4 rounded-full text-sm sm:text-lg transition-all duration-300 shadow-[0_0_20px_rgba(255,107,26,0.6)] hover:shadow-[0_0_30px_rgba(255,107,26,0.8)] hover:bg-[#ff6b1a]/90 w-full sm:w-auto sm:min-w-[180px] max-w-[240px] sm:max-w-[280px]">
            Get in Touch
          </button>
