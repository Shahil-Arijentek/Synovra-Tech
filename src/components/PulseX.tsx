...
export const BentoGridItem = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group/bento relative flex flex-col justify-end overflow-hidden rounded-3xl border border-white/10 min-h-[20rem] md:min-h-[12.5rem]",
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          background: isHovered ? "rgba(13, 13, 13, 0.85)" : "rgba(13, 13, 13, 0.7)",
        }}
