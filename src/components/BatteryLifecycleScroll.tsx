    ...
    const getCardPosition = () => {
      ...
      if (sceneIndex === 0) {
        ...
        if (cardData.position === 'right') {
          ...
          return 'left-8 sm:left-10 md:left-20 top-[70%] sm:top-[72%] md:top-[43rem]'
        }
        ...
        if (cardData.position === 'bottom-right') return 'left-8 sm:left-10 md:left-20 top-[45%] sm:top-[47%] md:top-[27rem]'
