        ...
        <div className="w-full max-w-[1200px]">
          <AnimatePresence mode="wait" initial={false}>
            ...
            >
              ...
              <div className="flex w-full md:w-1/2 flex-col justify-center items-center md:items-start text-center md:text-left px-4 md:px-0 min-h-[250px] sm:min-h-[350px] md:h-[400px] mt-0 sm:mt-0">
                <motion.h3 
