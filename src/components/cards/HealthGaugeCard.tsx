...
export default function HealthGaugeCard({ value, video = '99.mp4', width = '420px' }: HealthGaugeCardProps) {
  ...
  return (
    <div 
      ref={containerRef}
      className="backdrop-blur-[14.9px] bg-black/80 border border-white/10 rounded-2xl p-4 h-[240px] shadow-[inset_0px_14.368px_57.47px_0px_rgba(0,0,0,0.3)]"
      style={{ width }}
    >
      ...
      <div className="relative w-full h-full overflow-hidden">
        ...
        <div className="absolute top-0 left-0 z-10">
          <div className="text-[#9CA3AF] text-[10px] font-['Arial',sans-serif] tracking-wider">
            HEALTH %
          </div>
        </div>
        ...
        <div className="absolute bottom-0 right-0 z-10">
          <div 
            className="text-white font-['Gemunu_Libre',sans-serif] font-normal"
            style={{
              fontSize: '28.754px',
              lineHeight: '36.754px'
            }}
