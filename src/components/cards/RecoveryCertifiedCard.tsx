export default function RecoveryCertifiedCard() {
  return (
    <div className="backdrop-blur-[14.9px] bg-black/80 border border-white/10 rounded-xl md:rounded-2xl p-2 md:p-4 w-[300px] sm:w-[320px] md:w-[420px] h-[140px] sm:h-[150px] md:h-[180px] shadow-[inset_0px_14.368px_57.47px_0px_rgba(0,0,0,0.3)]">
      ...
      <div className="relative w-full h-[110px] sm:h-[120px] md:h-[110px] mb-1 flex items-center justify-center">
        <img
        ...
        <div className="absolute inset-0 flex items-center justify-center gap-3">
          ...
          <div className="text-left">
            <p className="text-black text-xl sm:text-2xl md:text-[32px] font-['Gemunu_Libre',sans-serif] font-bold uppercase leading-none mb-1">
              RECOVERY
            </p>
            <p className="text-black text-sm sm:text-base md:text-[16px] font-['Arial',sans-serif] font-normal uppercase leading-none">
              CERTIFIED
            </p>
          </div>
        </div>
