...
export default function PerformanceRestoredCard({ 
  ...
  return (
    <div className="backdrop-blur-[14.9px] bg-black/80 border border-white/10 rounded-2xl p-3 md:p-4 w-[280px] md:w-[420px] shadow-[inset_0px_14.368px_57.47px_0px_rgba(0,0,0,0.3)]">
      ...
      {/* Voltage Comparison */}
      <div className="mb-6">
        <div className="text-[#9CA3AF] text-[14px] font-['Arial',sans-serif] mb-2 text-center">
          Voltage
        </div>
        <div className="flex items-center justify-center gap-3">
          <span className="text-white text-[28px] md:text-[40px] font-['Gemunu_Libre',sans-serif] font-normal">
            {voltageFrom}
          </span>
          <span className="text-white text-[18px] md:text-[24px]">→</span>
          <span className="text-[#FF6B00] text-[28px] md:text-[40px] font-['Gemunu_Libre',sans-serif] font-normal">
            {voltageTo}
          </span>
        </div>
      </div>
