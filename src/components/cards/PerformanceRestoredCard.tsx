    ...
    <div className="backdrop-blur-[14.9px] bg-[#111111]/70 border border-white/10 rounded-2xl p-4 w-[420px] shadow-[inset_0px_14.368px_57.47px_0px_rgba(0,0,0,0.3)]">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-center gap-3">
          <span className="text-white text-[40px] font-['Gemunu_Libre',sans-serif] font-normal">
            {voltageFrom}
          </span>
          <span className="text-white text-[24px]">→</span>
          <span className="text-[#FF6B00] text-[40px] font-['Gemunu_Libre',sans-serif] font-normal">
            {voltageTo}
          </span>
        </div>
      </div>
