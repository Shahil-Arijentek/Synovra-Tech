...
export default function VoltageCard({ value, status }: VoltageCardProps) {
  ...
  return (
    <div className="backdrop-blur-[14.9px] bg-black/80 border border-white/10 rounded-xl md:rounded-2xl p-2 md:p-4 w-[110px] sm:w-[120px] md:w-[210px] h-[120px] sm:h-[130px] md:h-[235px] shadow-[inset_0px_14.368px_57.47px_0px_rgba(0,0,0,0.3)] flex flex-col">
      {/* Title */}
