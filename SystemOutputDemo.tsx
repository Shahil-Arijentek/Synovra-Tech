...
//     // Auto-switch tabs based on scroll position for better alignment
//     useEffect(() => {
//         const handleScroll = () => {
...
//                                     onClick={() => {
//                                         setActiveTab(tab.id);
//                                         // Smooth scroll to align content when tab is clicked
...
//                                         }
//                                     }}
//                                     className={`relative py-1.5 md:py-4 text-[10px] md:text-[10px] font-black uppercase tracking-tighter md:tracking-[0.2em] transition-colors duration-500 ${activeTab === tab.id ? "text-white" : "text-white/40"
//                                         }`}
//                                 >
...
//                         </p>
//                         <button
//                             className="bg-[#ff6b1a] h-[48px] md:h-[58px] rounded-[4px] px-6 md:px-10 text-[#FFF] font-normal text-[15px] md:text-[18px] leading-normal md:leading-[28px] text-center border-none cursor-pointer transition-all duration-300 will-change-[box-shadow] hover:bg-[#ff6b1a]/90 shadow-[0_0_15px_rgba(255,107,26,0.4),0_0_30px_rgba(255,107,26,0.2)] hover:shadow-[0_0_20px_rgba(255,107,26,0.5),0_0_40px_rgba(255,107,26,0.25)] whitespace-nowrap"
//                             style={{ fontFamily: 'Arial' }}
//                         >
